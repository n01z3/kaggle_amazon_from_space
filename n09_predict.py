...
def compare():
    ...
    y_1 = np.load(f'dump/rxn50_{nfold}_1crop.npy')
    y_18 = np.load(f'dump/rxn50_{nfold}_18crop.npy')
    y_21 = np.load(f'dump/rxn50_{nfold}_21crop.npy')
    y_24 = np.load(f'dump/rxn50_{nfold}_24crop.npy')
    y_39 = np.load(f'dump/rxn50_{nfold}_39crop.npy')
    print(y_39.shape)

    print(logloss_score(y_val, y_1))
    print(logloss_score(y_val, y_24))
    print(logloss_score(y_val, y_39))

    print('1crop:', f2beta(y_val, y_1))
    print('18crop:', f2beta(y_val, y_18))
    print('21crop:', f2beta(y_val, y_21))
    print('24crop:', f2beta(y_val, y_24))
    print('39crop:', f2beta(y_val, y_39))
...
def add_fit_args(train):
    ...
    train.add_argument('--start', default=9, type=int, help='start fold')
